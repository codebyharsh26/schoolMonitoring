                                    ...
                                    <div class="d-flex flex-nowrap gap-4">
                                        ...
                                        <div class="col my-card card">
                                            <div class="admin-custom-card-content card-body">
                                                ...
                                                <h1 class=" mt-1 mb-3" style="font-size: 3rem; margin-left: 0.8rem;">55
                                                </h1>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col my-card card">
                                            <div class="admin-custom-card-content card-body">
                                                ...
                                                <h1 class="mt-1 mb-3" style="font-size: 3rem; margin-left: 0.8rem;">269
                                                </h1>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col my-card card">
                                            <div class="admin-custom-card-content card-body">
                                                ...
                                                <h1 class="mt-1 mb-3" style="font-size: 3rem; margin-left: 0.8rem;">19
                                                </h1>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col my-card card">
                                            <div class="admin-custom-card-content card-body">
                                                ...
                                                <h1 class="mt-1 mb-3" style="font-size: 3rem; margin-left: 0.8rem;">10
                                                </h1>
                                            </div>
                                        </div>
                                    </div>

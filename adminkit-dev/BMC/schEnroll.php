...
<body>
    <div class="wrapper p-0 m-0">
        ...
        <div class="main">
            ...
            <form action="schEnroll.php" method="post">
                        ...
                        <div class="form-section">
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="school_no" class="required">School Number (Id)</label>
                                    <input type="number" id="school_no" name="school_no" required>
                                </div>
                                <div class="form-group">

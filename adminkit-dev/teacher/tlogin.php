...
<form method="post" class="form1">
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($isEmail) {
            $query = "SELECT * FROM teacher_1 WHERE email_address = '$email' AND password = '$password'";
        } else {
            $query = "SELECT * FROM teacher_1 WHERE phone_number = '$phone' AND password = '$password'";
        }
...
if (mysqli_num_rows($result) > 0) {
    ...
    $_SESSION["teacher_id"] = $teacher_data["id"]; // Assuming you have an id column

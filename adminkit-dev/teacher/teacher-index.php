...
<body>
    <div class="wrapper p-0 m-0">
		...
		?>
            ...
            <!-- marks section -->
            <section id="marks">
                <h1 class="h3 mb-1 ml"><strong class="h1">Marks</strong> Entry</h1>
                <div class="wrapper">
                    <div class="main">
                ...
                ?>
                            <form id="marksForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="studentId" name="roll_number" placeholder="Enter roll number"
                                        required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="subject-fields">
                                        ...
                                        <div class="subject-field">
                                            ...
                                            <input type="number" id="gujarati" name="gujarati" placeholder="Enter marks"
                                                min="0" max="100">
            ...
            <section id="leave-history">
                <h1 class="h3 mb-3 ml"><strong class="h1">Leave</strong> History</h1>
                <div class="container mt-1 p-4 mb-5">
    ...
    ?>
                            <tr>
                                ...
                                <td style="font-size: 20px;"><?php echo htmlspecialchars($leave["start_date"]); ?></td>
                                <td style="font-size: 20px;"><?php echo htmlspecialchars($leave["end_date"]); ?></td>
                                <td style="font-size: 20px;"><?php echo htmlspecialchars($leave["reason"]); ?></td>
                                <td>
                                    <?php
            ...
            <section id="announcement">
                ...
                <div class="fill ">
                    <div class="container-f ">
                        ...
                        <label class="label" style="padding: 8px 4px;" for="standardFilter">Filter by Standard:</label>
